...
This skill uses the [Membrane](https://getmembrane.com) CLI to interact with Intuiface. Membrane handles authentication and credentials refresh automatically — so you can focus on the integration logic rather than auth plumbing.
